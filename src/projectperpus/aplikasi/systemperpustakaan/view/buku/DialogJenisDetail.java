 ...
 * @author ahza
 */
public class DialogJenisDetail extends javax.swing.JDialog {
    boolean isNew = false;
    BukuController controller;
    
    /** Creates new form DialogKategoriDetail */
    public DialogJenisDetail(java.awt.Frame parent, boolean modal, BukuController controller) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(controller.getJenisView());
        this.controller = controller;
        controller.setJenisDetail(this);
        setButton();
        isNew = true;
        buttonSave.setEnabled(UserUtility.privilege[UserUtility.INSERT]);
    }

    public DialogJenisDetail(java.awt.Frame parent, boolean modal, BukuController controller, int idJenis) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(controller.getJenisView());
        this.controller = controller; 
        controller.setJenisDetail(this);
        setButton();
        controller.showDetailJenis(idJenis);
    ...
    public final void setButton(){
        buttonSave.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if(isNew)
                    controller.saveNewJenis();
                else
                    controller.saveUpdateJenis();
            }
        });
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Daftar Jenis Buku");

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel8.setText("Datar Jenis ");

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("Koleksi Perpustakaan");
