...
public class ViewAnggota {
    ...
    public ViewAnggota(int id, String nim, String nama, String jurusan,
    		String kotaLahir, Date tanggalLahir, String alamat, String email, 
    		String telepon, Date tanggalReg, Date akhirReg)
    {
        this.id = id;
        this.nim = nim;
        this.nama = nama;
